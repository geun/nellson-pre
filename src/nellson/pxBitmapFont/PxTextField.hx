...
class PxTextField extends Sprite 
{
	...
	public function drawText(Graph:Graphics, ?X:Float = 0, ?Y:Float = 0, ?Scale:Float =1 ):Void
	{
		...
		Graph.beginBitmapFill(bitmapData, _mtx, false, false);
